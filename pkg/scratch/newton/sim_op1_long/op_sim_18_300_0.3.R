source("~/proteinevoutk20/pkg/R/hessian.R") 
 ...
 op_seq=rep(1,300) 
 system.time(sim <- simTree(trees[[14]],300,op_seq,20,0.3,Nu_vec,alpha=al,beta=be,gamma=ga,rootseq=start_seq, ancestral=TRUE)) 
 ...
 save.image(file="op_simu_18_300_0.3.RData",compress=TRUE) 
