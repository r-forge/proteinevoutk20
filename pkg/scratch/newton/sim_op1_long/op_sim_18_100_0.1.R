source("~/proteinevoutk20/pkg/R/hessian.R") 
 ...
 op_seq=rep(1,100) 
 system.time(sim <- simTree(trees[[14]],100,op_seq,20,0.1,Nu_vec,alpha=al,beta=be,gamma=ga,rootseq=start_seq, ancestral=TRUE)) 
 ...
 save.image(file="op_simu_18_100_0.1.RData",compress=TRUE) 
