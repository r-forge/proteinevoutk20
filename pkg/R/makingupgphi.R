...
gphi<-abs(rnorm(length(true.phi), 10*true.phi^5, 0.01))
...
plot(bad.phi, gphi)
plot(awful.phi, gphi)
plot(true.phi, gphi/true.phi, log="xy")
plot(bad.phi, gphi/bad.phi,log="xy")
plot(awful.phi, gphi/awful.phi,log="xy")
#plot(true.phi, gphi)