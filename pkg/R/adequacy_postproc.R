...
for(gene in 1:106){
  ...
  if(file.exists(RDatafile)){
    ...
    gphi <- c(gphi,NA)
    pdiff_emp_emp <- c(pdiff_emp_emp,NA)
    pdiff_new_emp <- c(pdiff_new_emp,NA)
    pdiff_emp_new <- c(pdiff_emp_new,NA)
    pdiff_new_new <- c(pdiff_new_new,NA)
    dis_diff_emp_emp <- c(dis_diff_emp_emp,NA)
    dis_diff_new_emp <- c(dis_diff_new_emp,NA)
    dis_diff_emp_new <- c(dis_diff_emp_new,NA)
    dis_diff_new_new <- c(dis_diff_new_new,NA)
  }
