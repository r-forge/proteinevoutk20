source("~/proteinevoutk20/pkg/R/hessian.R") 
 ...
 op_seq=rep(1,700) 
 system.time(sim <- simTree(trees[[7]],700,op_seq,20,0.7,Nu_vec,alpha=al,beta=be,gamma=ga,rootseq=start_seq, ancestral=TRUE)) 
 ...
 save.image(file="op_simu_7_700_0.7.RData",compress=TRUE) 
