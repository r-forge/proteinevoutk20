...
obs.data <- conv(filename=fastafile,range=charset[[gene]],type="num") #observed data sequences
obs.seq <- obs.data[dtip,] #the one sequence at the deleted tip
...
dis.vec <- apply(obs.data,MARGIN=1,FUN=pchem_d,protein2=obs.data[dtip,],DisMat=dismat)
