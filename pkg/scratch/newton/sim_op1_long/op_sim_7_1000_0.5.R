source("~/proteinevoutk20/pkg/R/hessian.R") 
 ...
 op_seq=rep(1,1000) 
 system.time(sim <- simTree(trees[[7]],1000,op_seq,20,0.5,Nu_vec,alpha=al,beta=be,gamma=ga,rootseq=start_seq, ancestral=TRUE)) 
 ...
 save.image(file="op_simu_7_1000_0.5.RData",compress=TRUE) 
