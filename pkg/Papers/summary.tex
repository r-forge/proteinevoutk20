...
This formulat for the fixation of a mutant allele is valid under weak mutation assumptions, i.e. $\mu N_e \ll 1$.[SELLA AND HIRSH NEVER MENTION WEAK SELECTION IN MAIN TEXT. ONLY WEAK MUTATION. SHOULD CHECK SUPPORTING MATERIALS] %under the condition $s, \frac{1}{N}, Ns^2 \ll 1$ where $s$ is the selelction advantage/disadvantage of the mutant over the resident. (Add ref or delete)\\
